...
if st.session_state.page == "main":
    ...
    with col_out:
        ...
        # 4. PDF生成・ダウンロード（ここも一箇所に集約）
        st.markdown("---")
        if st.button("📄 PDFレポートを生成・保存", use_container_width=True, key="unique_pdf_gen_btn"):
            report_data = {
                ...
                "insensible": insensible_total, "net": net_val, "judgment": judg,
                "recorder": recorder
            }
